...
To protect your personal data in this public repository, **do not write yasdour real name or student ID in any committed file**. You will
use an anonymous hash generated by a local Python script.ssdfasd

Agregamos mas introducion
---
